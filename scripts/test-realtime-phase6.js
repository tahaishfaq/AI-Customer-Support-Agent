...
assert.match(gateway, /connectionsClosed/);
assert.match(gateway, /\[realtime\] connected/);
assert.match(gateway, /\[realtime\] disconnected/);
assert.match(gateway, /lastConnectionRejectionReason/);
