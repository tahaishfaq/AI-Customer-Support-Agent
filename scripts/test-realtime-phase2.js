...
assert.match(quota, /BILLING_SUBSCRIPTION_UPDATED/);
assert.match(quota, /setInterval\(onRefreshEvent, 60_000\)/);
assert.match(badge, /HANDOFF_CREATED/);
assert.match(badge, /DESK_NAV_BADGE_POLL_MS/);
assert.match(inbox, /REALTIME_CLIENT_EVENTS\.EVENT/);
