# Hapy — Kya kya ship hua (F01–F09 + extras)
...
**Check sab theek hai:** `npm run test:shipped`

**Aage ka kaam:** **[F00 DoD/demo buffer](features/F00_DOD_DEMO_BUFFER.md)** abhi → phir **[F11 Actions](features/F11_AGENT_ACTIONS.md)**. Alt: [F12 Desk](features/F12_HUMAN_DESK.md) · [F10 RAG](features/F10_SEMANTIC_RAG.md) only if KB pain. OOS later: [`ROADMAP_NEXT.md`](ROADMAP_NEXT.md) §4.
...
8. CI + smoke test suite (`test:shipped`)
...
7. Terminal: `npm run test:shipped` green  
...
| Tests | `scripts/test-f*.mjs`, `npm run test:shipped` |

---

*Last updated: Aug 2026 — F01–F09 production smoke passed + scheduled re-crawl shipped.*
