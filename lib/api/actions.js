...
export async function createAgentActionDraftRevision(agentId, actionId, body = {}) {
  return apiFetch(`/api/agents/${agentId}/actions/${actionId}/revisions`, {
    method: "POST",
    body: JSON.stringify(body),
  });
}

export async function publishAgentActionRevision(agentId, actionId, revisionId) {
  return apiFetch(
    `/api/agents/${agentId}/actions/${actionId}/revisions/${revisionId}/publish`,
    { method: "POST" }
  );
}

export async function rollbackAgentActionRevision(agentId, actionId, revisionId) {
  return apiFetch(
    `/api/agents/${agentId}/actions/${actionId}/revisions/${revisionId}/rollback`,
    { method: "POST" }
  );
}
...
export async function importAgentOpenApiActions(agentId, body) {
  return apiFetch(`/api/agents/${agentId}/actions/openapi-import`, {
    method: "POST",
    body: JSON.stringify(body),
  });
}
