...
/** Forgot-password OTP request (per IP / per email). */
export function forgotPasswordLimitOpts() {
  return {
    limit: intEnv("RATE_LIMIT_FORGOT_PASSWORD", 5),
    windowMs: intEnv("RATE_LIMIT_FORGOT_PASSWORD_WINDOW_MS", 15 * 60_000, {
      min: 60_000,
      max: 86_400_000,
    }),
  };
...
/** Reset-password attempts (per IP / per email). */
export function resetPasswordLimitOpts() {
  return {
    limit: intEnv("RATE_LIMIT_RESET_PASSWORD", 5),
    windowMs: intEnv("RATE_LIMIT_RESET_PASSWORD_WINDOW_MS", 15 * 60_000, {
      min: 60_000,
      max: 86_400_000,
    }),
  };
...
/** Verify-email token attempts. */
export function verifyEmailLimitOpts() {
  return {
    limit: intEnv("RATE_LIMIT_VERIFY_EMAIL", 10),
    windowMs: intEnv("RATE_LIMIT_VERIFY_EMAIL_WINDOW_MS", 15 * 60_000, {
      min: 60_000,
      max: 86_400_000,
    }),
  };
...
export function resendVerifyLimitOpts() {
  return {
    limit: intEnv("RATE_LIMIT_RESEND_VERIFY", 5),
    windowMs: intEnv("RATE_LIMIT_RESEND_VERIFY_WINDOW_MS", 15 * 60_000, {
      min: 60_000,
      max: 86_400_000,
    }),
  };
