 ...
 * @property {{ customerSubject?: string|null, endUserAccessToken?: string|null, customerClaims?: { email?: string|null, phone?: string|null }|null }} [identity]
...
export async function runTurn(ctx) {
  ...
  safeLog("info", "orchestrator.turn", {
    ...
    sourceRoute: routeSource(ctx.userMessage ?? null).route,
