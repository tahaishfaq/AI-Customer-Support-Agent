      ...
      : stopReason === "escalate"
        ...
        : githubFailedInventory
          ? userAskedForRepoList(lastUserMessage)
            ...
            : userAskedForGithubWrite(lastUserMessage)
              ? "Connected GitHub MCP did not complete the repository write (create/update). Tell the user the create/update did not finish. Do not invent success or repo URLs."
