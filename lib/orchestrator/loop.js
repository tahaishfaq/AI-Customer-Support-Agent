      ...
      : stopReason === "escalate"
        ...
        : githubFailedInventory
          ? userAskedForRepoList(lastUserMessage)
            ...
            : userAskedForGithubWrite(lastUserMessage)
              ? "Connected GitHub MCP did not complete the repository write (create/update). If the tool said the name already exists / is taken, tell the user that name is taken, suggest 1–2 alternate names, and ask them to Confirm one — do not claim success or invent repo URLs."
