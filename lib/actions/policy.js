...
export function evaluateActionPolicy({
  ...
  // F11-U: every live HTTP tool on the public embed requires Confirm (studio can auto-run).
  // Owner-connected MCP READ (e.g. GitHub get_me) uses the agent's credential, not the
  // visitor's account — Confirm stays for WRITE/DESTRUCTIVE MCP and all HTTP embed tools.
