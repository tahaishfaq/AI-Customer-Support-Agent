...
export const ACTION_TEMPLATES = Object.freeze([
  ...
  },
  {
    ...
    description:
      "Look up a Shopify order by id via the Shopify Admin connector when a *.myshopify.com connection + access-token credential are attached. Template URL alone is not a live store.",
    method: "GET",
