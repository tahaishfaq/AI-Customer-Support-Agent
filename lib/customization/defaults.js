...
export const DEFAULT_CUSTOMIZATION = {
  ...
  deploy: {
    ...
    allowExpand: true,
    /** Launcher look: "pill" is the original AIDE launcher (rounded rectangle). */
    launcherShape: "pill",
    launcherSize: "md",
    /** Ring around the launcher: animated "gradient" (default), static "solid", or "none". */
    launcherBorder: "gradient",
    /** Ring color; null follows the brand primary color. */
