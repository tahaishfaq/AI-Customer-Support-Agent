 ...
 * @param {{ actionId?: string|null, mcpToolId?: string|null } | string} ref
 */
export function normalizeCapabilityRef(ref) {
  if (typeof ref === "string") {
    return { actionId: ref, mcpToolId: null };
  }
...
export async function createPendingConfirmation(
  ...
  const { actionId, mcpToolId } = normalizeCapabilityRef(capabilityRef);
