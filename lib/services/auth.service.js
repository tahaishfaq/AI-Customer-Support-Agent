...
import { afterCredentialsRegister } from "@/lib/services/email-lifecycle.service";
...
export async function registerUser({ name, email, password }) {
  ...
  // EM3 — welcome + soft verify (never block signup on mail failure).
  afterCredentialsRegister(user).catch(() => {});
