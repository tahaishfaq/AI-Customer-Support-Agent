...
export const areaClass =
  "min-h-[88px] max-h-32 resize-none overflow-y-auto rounded-xl border-[var(--color-border)] bg-white text-[var(--color-text)] shadow-none focus-visible:ring-[var(--color-primary)]/20";
